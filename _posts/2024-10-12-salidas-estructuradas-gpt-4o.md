...
# Recursos
- [How to use structured outputs with Azure OpenAI Service – Azure OpenAI](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/structured-outputs?tabs=python-secure)
- [Announcing a new OpenAI feature for developers on Azure](https://azure.microsoft.com/en-us/blog/announcing-a-new-openai-feature-for-developers-on-azure/)
